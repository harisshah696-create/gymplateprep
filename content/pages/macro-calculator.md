...
var isMale = sex ? sex.value === 'male' : true;
...
var bmr = isMale ? (10 * weight + 6.25 * height - 5 * age + 5) : (10 * weight + 6.25 * height - 5 * age - 161);
var tdee = bmr * activity;

var cal, proteinPct, carbsPct, fatPct, mealIdea;
if (goal === 'lose') { cal = tdee - 500; proteinPct = 0.40; carbsPct = 0.30; fatPct = 0.30; mealIdea = 'Try a high-protein breakfast (eggs + Greek yogurt) to stay full longer.'; }
else if (goal === 'gain') { cal = tdee + 300; proteinPct = 0.35; carbsPct = 0.40; fatPct = 0.25; mealIdea = 'Add an extra meal or shake — aim for 2g protein per kg of bodyweight.'; }
else { cal = tdee; proteinPct = 0.30; carbsPct = 0.40; fatPct = 0.30; mealIdea = 'Maintain balance: protein with every meal, prioritize whole food carbs.'; }
